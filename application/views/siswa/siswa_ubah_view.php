                            ...
                            <table >
                                ...
                                <tr>
                                    <td style="padding-right: 5px;">
                                        <input name='fotof' style=" width:100%; float:right; padding-right: 5px;" type="file">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input name='uplo' style=" width:100%; float:right; padding-right: 5px;" type="submit" value="Unggah Foto">
                                    </td>
                                </tr>
                            </table>
